...
| 41 | `41_SECURITY_PRIVACY_AND_COMPLIANCE.md` | 🔧 Authoritative security/privacy/compliance law (5th build pillar — trust & safety): data classification · AuthN/AuthZ (RBAC+ABAC+field-level) · tenant isolation · crypto/KMS · consent & DSR · tamper-evident audit · officiating signing · STRIDE+ML threat model · LLM/SSRF/media hardening · GDPR/biometric/EU-AI-Act mapping · CI-enforced security invariants (formalizes Part 31; honest status corrects Part 31 over-claims) |
